...
const cherryStudioConfig = (mcpUrl: string) => ({
  mcpServers: {
    [mcpName]: {
      name: mcpName,
      description: 'Empower your AI to read the U.S. stock market — real-time S&P 500 company data, precise search, total visibility.',
      ...
      <div className="max-w-300 mx-auto">
        ...
        <div className="mt-12">
          ...
          <div className="config-block animate-on-scroll bg-muted border border-border rounded-lg p-6 overflow-x-auto">
            <pre className="font-mono text-sm leading-relaxed text-foreground m-0 whitespace-pre">{mcpConfigJson(mcpUrl)}</pre>
          </div>
        </div>
      </div>
    </section>
